...
var hasAutoSignInConfig = (params) => {
  var _a, _b, _c, _d;
  return params.autoSignIn === true && !!((_a = params.loginUrl) == null ? void 0 : _a.trim()) && !!((_b = params.username) == null ? void 0 : _b.trim()) && !!params.password && !!((_c = params.usernameField) == null ? void 0 : _c.trim()) && !!((_d = params.passwordField) == null ? void 0 : _d.trim());
};
...
var createAutoSignInScript = (params) => {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j;
  const loginUrl = JSON.stringify((_b = (_a = params.loginUrl) == null ? void 0 : _a.trim()) != null ? _b : "");
  const method = JSON.stringify((_c = params.autoSignInMethod) != null ? _c : "GET");
  const usernameField = JSON.stringify((_e = (_d = params.usernameField) == null ? void 0 : _d.trim()) != null ? _e : "username");
  const passwordField = JSON.stringify((_g = (_f = params.passwordField) == null ? void 0 : _f.trim()) != null ? _g : "password");
  const username = JSON.stringify((_i = (_h = params.username) == null ? void 0 : _h.trim()) != null ? _i : "");
...
var normalizeGateOption = (gate) => {
  ...
  if (gate.autoSignInMethod === void 0) {
  ...
  if (gate.autoSignIn === void 0) {
    gate.autoSignIn = false;
  }
  if (gate.loginUrl === void 0) {
    gate.loginUrl = "";
  }
  if (gate.username === void 0) {
    gate.username = "";
  }
  if (gate.password === void 0) {
    gate.password = "";
  }
  if (gate.usernameField === "" || gate.usernameField === void 0) {
    gate.usernameField = "username";
  }
  if (gate.passwordField === "" || gate.passwordField === void 0) {
    gate.passwordField = "password";
  }
  if (gate.openMode === void 0) {
    gate.openMode = "tab";
  }
  return gate;
};
...
var FRAME_TAB_CLASS = "extended-browser-tab-frame";
var FRAME_FLOATING_CLASS = "extended-browser-floating-frame";
var WEBVIEW_INLINE_CLASS = "extended-browser-webview-inline";
var clearFloatingFrameCssProps = (frameEl) => {
  frameEl.setCssProps({
    width: "",
    height: "",
    minWidth: "",
...
var GateView = class extends import_obsidian.ItemView {
...
var createLinkConvertMenu = (menu, editor) => {
